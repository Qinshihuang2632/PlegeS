...
export const HLGX_Audio = (() => {
    ...
    return {
        ...
        hurt()   { tone(320, 0.22, "square", 0.12); tone(210, 0.30, "square", 0.10, 0.07); }, // 扣血(误消/答错)
        clear()  { tone(660, 0.12, "sine", 0.14); tone(990, 0.18, "sine", 0.12, 0.07); }, // 消除(答对)
        ...
        /* 语义别名(v2.9.0 起四游戏通用): correct=答对, wrong=答错/扣血 */
        correct() { this.clear(); },
        wrong()   { this.hurt(); },
    };
})();
