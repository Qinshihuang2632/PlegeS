...
export const FLGL_RULE_SECTIONS = [
    {
        title: "怎么玩",
        points: [
            "传送带每隔一段时间送出一张物质卡(化了个学物质库 296 种),从右侧匀速进入;",
    ...
    },
    {
        title: "传送带与判负",
        points: [
            "出牌间隔:简单 5.5 秒 / 标准 4 秒 / 困难 2.5 秒(传送带右上有下一张倒计时);",
            "卡牌缓缓滑入,滑行途中就可以按住拖去分类,不必等它停稳;",
            "传送带容量:简单/标准 5 张、困难 4 张(困难模式传送带也相应变短);堆积满时不会立刻输——你有整个出牌间隔的时间腾出空位;",
    ...
    },
    {
        title: "双类别物质",
        points: [
            "有机酸(醋酸、甲酸、草酸、丙烯酸、苯甲酸、甘氨酸)既是「酸」也是「有机物」——放两者之一都算对(与化了个学的双身份消除一致);",
    ...
    },
    {
        ...
        points: [
            ...
            "标准:7 大类别(无混合物)均衡出现;",
            "困难:全部 8 类 296 种物质随机出现,出牌更快,传送带容量只有 4 张;",
