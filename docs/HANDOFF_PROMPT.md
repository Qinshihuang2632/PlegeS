...
| 英了个语 | ylgy | **v1.5.1** | 交叉单词网格填词,课标词库 |
| 错了个字 | clgz(cuolegezi) | **v1.0.7**(维护中) | 手写考察高中各科易写错的字 |
| 分了个类 | flgl | **v1.1.1** | 传送带式物质分类,拖入 8 类,满载到点判负 |
| 配了个平 | plgp | **v1.0.1** | 方程式配平闯关,比例解判错,111 条审定题库 |
